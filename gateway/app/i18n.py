...
I18N_DICT: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "tasks.workbench.subtitles.soft_detected": "检测到软字幕轨道（可在转码时移除字幕轨）",
        "tasks.workbench.subtitles.none_detected_hint": "未检测到字幕轨道。若为硬字幕，v1.85 无法移除，v1.9 将增强。",
    ...
    "mm": {
        ...
        "tasks.workbench.subtitles.soft_detected": "Soft subtitle track တွေ့ရှိသည် (transcode အချိန် subtitle stream ဖယ်ရှားနိုင်သည်)",
        "tasks.workbench.subtitles.none_detected_hint": "Subtitle track မတွေ့ပါ။ Hard subtitle ဖြစ်ပါက v1.85 မဖယ်ရှားနိုင်ပါ။ v1.9 တွင် တိုးတက်ပါမည်။",
